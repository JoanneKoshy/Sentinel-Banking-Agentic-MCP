"""
Transaction Agent - calls the Transactions MCP server. Tracks
latency/errors via observability.py, and history for follow-up questions.
"""
...
SYSTEM_PROMPT = (
    "You are the Transaction Agent for a bank's customer support system. "
    "You ONLY answer questions about recent transactions or monthly statements, "
    "for the currently authenticated customer. You cannot look up any other "
    "customer's data. "
    "You have two tools available: get_transactions and get_statement. Call "
    "them directly - you do not need to ask the user for any IDs or tokens. "
    "Use the conversation history to understand follow-up questions. "
    "If the question is not about transactions or statements, say you cannot help."
)
...
async def handle_message(
    ...
    with observability.track_agent_call("transaction"):
